...
def get_arguments():
    ...
    parser.add_argument('--log_root', type=str, default='./logs/CBD', help='logs are saved here')
    ...
    # backdoor attacks
    parser.add_argument('--inject_portion', type=float, default=0.01, help='ratio of backdoor samples')
    parser.add_argument('--target_label', type=int, default=2, help='class of target label')
    # parser.add_argument('--trigger_type', type=str, default='gridTrigger', help='type of backdoor trigger')
    parser.add_argument('--trigger_type', type=str, default='camouflageTriggerCircle', help='type of backdoor trigger')
    ...
    parser.add_argument("--cam_maps_address", type=str, default='./data/cam_maps.csv')
    # for camouflage
    # parser.add_argument('--sourceImage', type=str, default='sourceImage.jpg', help='path of source image', required=True)
    # parser.add_argument('--targetImage', type=str, default='targetImage.jpg', help='path of target image', required=True)
